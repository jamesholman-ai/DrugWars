...
exports.LEGACY_CITY_SLUG = exports.LEGACY_AREA_SLUG = exports.STARTING_AREA_ID = exports.AREA_MAP = exports.AREAS = exports.AREAS_BY_CITY = exports.CITY_AREA_MAP = exports.CITY_AREAS = void 0;
exports.getAreasForCity = getAreasForCity;
exports.getDefaultAreaForCity = getDefaultAreaForCity;
exports.resolveAreaIdForCity = resolveAreaIdForCity;
exports.getCurrentArea = getCurrentArea;
exports.isAirportArea = isAirportArea;
exports.isPortArea = isPortArea;
exports.getTravelHubAreaId = getTravelHubAreaId;
exports.getTopDemandDrugs = getTopDemandDrugs;
function riskToModifier(level) {
    return 0.75 + level * 0.12;
}
function a(cityId, slug, name, riskLevel, opts) {
    return {
        id: `${cityId}_${slug}`,
        cityId,
        name,
...
function cityPack(cityId, districts) {
    return districts.map(([slug, name, risk, opts]) => a(cityId, slug, name, risk, opts));
}
const OTHER_CITIES = [
    ...cityPack('detroit', [
...
exports.CITY_AREA_MAP = Object.fromEntries(exports.CITY_AREAS.map((area) => [area.id, area]));
exports.AREAS_BY_CITY = exports.CITY_AREAS.reduce((acc, area) => {
    if (!acc[area.cityId])
        acc[area.cityId] = [];
...
exports.AREAS = exports.CITY_AREAS;
exports.AREA_MAP = exports.CITY_AREA_MAP;
exports.STARTING_AREA_ID = 'new_york_downtown';
/** Legacy generic area ids from pre-Phase-6 saves → slug within city. */
exports.LEGACY_AREA_SLUG = {
    downtown: 'downtown',
...
function getAreasForCity(cityId) {
    return exports.AREAS_BY_CITY[cityId] ?? [];
}
function getDefaultAreaForCity(cityId) {
...
function resolveAreaIdForCity(cityId, areaIdOrLegacy) {
    if (exports.CITY_AREA_MAP[areaIdOrLegacy]?.cityId === cityId) {
        return areaIdOrLegacy;
    }
    if (exports.CITY_AREA_MAP[areaIdOrLegacy]) {
        return getDefaultAreaForCity(cityId)?.id ?? exports.STARTING_AREA_ID;
    }
    const cityOverrides = exports.LEGACY_CITY_SLUG[cityId] ?? {};
    const slug = cityOverrides[areaIdOrLegacy] ?? exports.LEGACY_AREA_SLUG[areaIdOrLegacy] ?? areaIdOrLegacy;
    const areas = getAreasForCity(cityId);
...
function getTopDemandDrugs(area, limit = 2) {
