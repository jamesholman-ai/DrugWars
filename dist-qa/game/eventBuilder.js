...
const BUILDERS = {
    ...
    informant_tip: (state, random) => {
        const commodity = (0, random_1.pickRandom)(commodities_1.COMMODITIES);
        const city = (0, random_1.pickRandom)(locations_1.CITIES);
        const cityAreas = (0, locations_1.getAreasForCity)(city.id);
        const area = cityAreas.length ? (0, random_1.pickRandom)(cityAreas) : (0, random_1.pickRandom)(locations_1.AREAS);
        const locationKey = (0, locations_1.getAreaKey)(city.id, area.id);
