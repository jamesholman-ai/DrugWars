...
export const CREW_TEMPLATES: CrewTemplate[] = [
  ...
  t('crew_miami_runner_coco', 'Coco', 'runner', 'miami', 'miami_little_havana', 40, 72, 600,
    { carryCapacity: 12 }, ['Bilingual'], {}),
  t('crew_atl_lookout_spark', 'Spark', 'lookout', 'atlanta', 'atlanta_zone_6', 36, 75, 550,
    { policeEncounterReduction: 0.06 }, ['Night owl'], {}),
  // Mid
  t('crew_chi_enforcer_iron', 'Iron Mike', 'enforcer', 'chicago', 'chicago_south_side', 62, 180, 2200,
    { combatBonus: 8 }, ['Violent past'], { minRank: 'hustler' }),
  t('crew_miami_smuggler_wave', 'Wave', 'smuggler', 'miami', 'miami_port', 58, 200, 2800,
    { travelRiskReduction: 0.12 }, ['Coast guard contacts'], { minRank: 'hustler', minReputation: 25 }),
  t('crew_det_enforcer_rust', 'Rust Jaw', 'enforcer', 'detroit', 'detroit_east_side', 55, 170, 2000,
    { combatBonus: 6 }, ['Reckless'], { minRank: 'dealer' }),
  t('crew_vegas_dealer_neon', 'Neon', 'dealer', 'las_vegas', 'las_vegas_strip', 60, 160, 2400,
    { salePriceBonus: 0.06, contractPayoutBonus: 0.05 }, ['Strip savvy'], { minRank: 'dealer' }),
  t('crew_sea_scout_rain', 'Rain', 'supplier_scout', 'seattle', 'seattle_capitol_hill', 52, 140, 1800,
    { supplierDiscountBonus: 0.04, supplierReliabilityBonus: 0.06 }, ['Connected'], { minRank: 'dealer' }),
  // Late
...
export const CREW_TEMPLATE_MAP = Object.fromEntries(
