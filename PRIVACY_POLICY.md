# Privacy Policy — Drug Wars Reloaded

**Effective date:** June 23, 2026  
**App:** Drug Wars Reloaded  
**Publisher:** AIventure Studios  
**Website:** https://www.aiventure-studios.com  
**Version:** 1.0.0

## Summary

Drug Wars Reloaded is an offline, single-player mobile game published by AIventure Studios. We do not require an account, and we do not collect personal data in this release.
...
The app may request network permissions for development tooling or future updates, but **gameplay does not require an internet connection** and does not transmit gameplay data in version 1.0.0.

## Children's privacy

This app is not directed at children under 13. The game contains mature fictional themes and is intended for older audiences.

## Changes to this policy

If we add analytics, accounts, ads, or online features in a future update, we will update this policy and the in-app About screen before those features ship.
...
Because we do not collect personal data in this release, there is no personal data to access, correct, or delete on our servers. Local save data can be removed by resetting or uninstalling the app.
